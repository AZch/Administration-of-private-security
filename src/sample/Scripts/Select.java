...
public class Select {
    ...
    public static final String getDataActPaying = "select datacreate_aop, datapay_aop, idactpay from ACTOFPAYING";
    ...
    public static final String getDataLOA = "select idiineact, dogovor_iddogovor, datafact_loa, datasuppose_loa, payment_loa, factpay_loa, paytype_loa from lineofact";
    ...
    public static final String getDataDog = "select payperiod_dog, datastart_dog, dataend_dog, series_dog from dogovor";
